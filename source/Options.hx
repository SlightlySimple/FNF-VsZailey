...
class RotateNotesOption extends Option
{
	...
	private override function updateDisplay():String
	{
		return "Rotate Notes: < " + (FlxG.save.data.rotateNotes ? "Enabled" : "Disabled") + " >";
	}
}
...
class QuantColorOption extends Option
{
	...
	public override function left():Bool
	{
		...
		if (FlxG.save.data.stepManiaColors[color] < 0)
			FlxG.save.data.stepManiaColors[color] = 3;
		display = updateDisplay();
		return true;
	}
	...
	{
		FlxG.save.data.stepManiaColors[color]++;
		if (FlxG.save.data.stepManiaColors[color] > 3)
	...
	private override function updateDisplay():String
	{
		var quantValues:Array<String> = ['4TH', '8TH', '12TH', '16TH', '24TH', '32ND'];
		var colorValues:Array<String> = ['Purple', 'Blue', 'Green', 'Red'];
		return quantValues[color] + " NOTE: < " + colorValues[FlxG.save.data.stepManiaColors[color]] + " >";
	}
}
...
class ColorIconsOption extends Option
{
	public function new(desc:String)
	{
		super();
	...
	public override function left():Bool
	{
		if (OptionsMenu.isInPause)
			return false;
		FlxG.save.data.colorIcons = !FlxG.save.data.colorIcons;
		display = updateDisplay();
		return true;
	}
	...
	private override function updateDisplay():String
	{
		return "Colored Icons: < " + (FlxG.save.data.colorIcons ? "Enabled" : "Disabled") + " >";
	}
}
